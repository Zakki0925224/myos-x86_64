...
const DEFAULT_THEME: Theme = Theme {
    ...
    wm_taskbar_color: COLOR_BLACK,
    wm_panel_back_color: COLOR_BLACK,
    wm_panel_border_color: COLOR_BLACK,
    wm_window_back_color: COLOR_BLACK,
    wm_window_border_color: COLOR_BLACK,
    wm_window_titlebar_back_color: COLOR_BLACK,
    wm_window_titlebar_fore_color: COLOR_BLACK,
    wm_window_close_button_back_color: COLOR_BLACK,
